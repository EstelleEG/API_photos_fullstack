    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 text-center mt-2">
                <h1>Welcome to 'Sharvani Studio'</h1>
                <br>
                <br>
                <h5>Choose the class you would like to attend with us</h5>
                <br>
                <br>
            ...
            <div v-for="pic in portfolio" class="col-12 col-md-4 mb-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a v-bind:href="pic.url" target="_blank" class="btn btn-primary">Book now</a>
                    </div>
                </div>
                <!-- fin card -->
            </div>
